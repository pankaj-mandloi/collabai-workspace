...
export function AIChatPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-[#0a0c0b] border-l border-white/10 shadow-2xl z-50 flex flex-col">
        {/* Ambient glow */}
        <div className="absolute top-0 left-0 w-full h-40 bg-emerald-500/[0.05] blur-2xl pointer-events-none" />

        {/* Header */}
        <div className="relative flex items-center justify-between p-4 border-b border-white/10 bg-[#0a0c0b]/90 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-lime-400 flex items-center justify-center shadow-lg shadow-emerald-500/20">
              <Bot className="w-5 h-5 text-black" />
            </div>
            <div>
              <h2 className="font-bold text-white text-base">AI Assistant</h2>
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-md flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/[0.05] transition-colors"
              title="Close"
            >
              <X className="w-4 h-4" />
            </button>
        ...
        {/* Input */}
        <div className="relative border-t border-white/10 bg-[#0a0c0b]/90 backdrop-blur-xl p-4">
          <div className="flex items-end gap-2">
            <div className="flex-1 relative">
              <Textarea
                ...
                disabled={isThinking}
                rows={1}
                className="min-h-[42px] max-h-[120px] resize-none bg-white/[0.03] border-white/10 text-white text-sm placeholder:text-slate-600 focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 pr-2"
              />
            </div>
